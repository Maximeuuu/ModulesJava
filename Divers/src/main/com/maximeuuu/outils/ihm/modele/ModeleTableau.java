...
import com.maximeuuu.outils.utilitaire.tableau.UtilitaireTableau;

/**
 * Classe métier du tableau
...
public class ModeleTableau extends AbstractTableModel
{
	...
	public void ajouterLigne ( )
	{
		...
		if ( this.tabDonnees.length == 0 || ! Arrays.equals ( this.tabDonnees[nbLignes-1], this.ensDefaut ) )
		{
			...
			Object[][] nouveauTableau = UtilitaireTableau.copier ( this.tabDonnees, this.ensDefaut );
